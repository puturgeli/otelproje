...
//dropmenuyu handle edip listesini ekrana yazdırın
        ...
        dropList.stream().forEach(t -> System.out.println(t.getText()));


//dropmenude 40 eleman oldugunu dogrulayın
        int actualdropmenuSize = dropList.size();
        int expectedSize = 40;
        Assert.assertFalse(actualdropmenuSize == expectedSize, "40 sayısına eşittir.");
 ...
 /*   Set<String> handleList=driver.getWindowHandles();
    ...
    public void test04() {
      //Test 04
        ...
        //sepetteki ürünlerle ekledigimiz ürünlerin aynı oldugunu isim ve fiyat olarak dogrulayın
